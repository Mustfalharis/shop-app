          ...
          Column(
            ...
            children: [
              Row(
                ...
                [
                 IconButton(
                     onPressed: ()
                     {
                       controller.removeProductFarmCart(productModels: producModels);
                     },
                     icon: Icon(
                         Icons.remove_circle,
                       color: Get.isDarkMode? Colors.white:Colors.black,
                  ...
                  IconButton(
                    onPressed: ()
                    {
                      controller.addProductToCart(productModels: producModels);
                    },
                    icon: Icon(
                        Icons.add_circle,
                      color: Get.isDarkMode? Colors.white:Colors.black,
              ...
              IconButton(
                  onPressed: ()
                  {
                  controller.removeOneProduct(productModels: producModels);
                  },
                  icon: Icon(
                      Icons.delete,
